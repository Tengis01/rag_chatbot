      ...
      >
        ...
        <div className="glass-strong shadow-elevated overflow-hidden rounded-[28px]">
          ...
          <div className="grid h-[560px] grid-cols-12">
            {/* LEFT SIDEBAR */}
            <div className="col-span-3 hidden flex-col gap-2 border-r border-border/40 p-3 md:flex">
              {/* New Chat */}
            ...
            {/* RIGHT SIDEBAR */}
            <div className="col-span-3 hidden flex-col border-l border-border/40 md:flex">
